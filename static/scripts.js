document.addEventListener("DOMContentLoaded", function () { 
    ...
    window.addEventListener("beforeunload", function () { loadingIndicator.style.display = "block"; }); 
    window.addEventListener("load", function () { loadingIndicator.style.display = "none"; }); 
});  
